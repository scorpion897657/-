        ...
        {currentUser.hasPermission("list_dashboards") && (
          <Menu.Item key="dashboards" className={activeState.dashboards ? "navbar-active-item" : null}>
            <Link href="dashboards">
              ...
              <span className="desktop-navbar-label">儀表板</span>
            </Link>
          </Menu.Item>
        )}
        {currentUser.hasPermission("view_query") && (
          <Menu.Item key="queries" className={activeState.queries ? "navbar-active-item" : null}>
            <Link href="queries">
              ...
              <span className="desktop-navbar-label">查詢</span>
            </Link>
          </Menu.Item>
        )}
      ...
      <NavbarSection>
        <Menu.Item key="help">
          <HelpTrigger showTooltip={false} type="HOME" tabIndex={0}>
            ...
            <span className="desktop-navbar-label">幫助</span>
          </HelpTrigger>
        </Menu.Item>
        {firstSettingsTab && (
          <Menu.Item key="settings" className={activeState.dataSources ? "navbar-active-item" : null}>
            <Link href={firstSettingsTab.path} data-test="SettingsLink">
              <SettingOutlinedIcon />
              <span className="desktop-navbar-label">設定</span>
            </Link>
          </Menu.Item>
        )}
      </NavbarSection>
      ...
      <NavbarSection className="desktop-navbar-profile-menu">
        <Menu.SubMenu
          ...
          <Menu.Item key="profile">
            <Link href="users/me">個人資訊</Link>
          </Menu.Item>
          {currentUser.hasPermission("super_admin") && (
            <Menu.Item key="status">
              <Link href="admin/status">系統狀態</Link>
            </Menu.Item>
          )}
          <Menu.Divider />
