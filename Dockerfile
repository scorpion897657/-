...
COPY ibm_db-3.1.4.tar.gz linuxx64_odbc_cli.tar.gz ./
RUN tar -zxvf ibm_db-3.1.4.tar.gz
RUN tar -zxvf linuxx64_odbc_cli.tar.gz -C ibm_db-3.1.4/
WORKDIR  /app/ibm_db-3.1.4
